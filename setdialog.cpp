...
#define SETDIALOG_BUTTON_SELECTED   "QToolButton{font: 125 13pt \"微软雅黑\";font-weight: bold;background-color:#e9e9e9;color:#353535;border:0px;}"
#define SETDIALOG_BUTTON_UNSELECTED "QToolButton{font: 13pt \"微软雅黑\";font-weight: bold;background-color:#f6f6f6;color:#353535;border:0px;}"
